...
public class FRS_TC_12 {
    ChromeDriver driver;

    @Test
    public void frs_tc_12() {
        ...
        driver.findElement(By.xpath("//input[@name='password']")).sendKeys("xyz123");

        //------Click Sign In--------------------------------------------------------------------------
        driver.findElement(By.xpath("//button[@qaattr='commonButtonsSignIn']")).click();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));

        //driver.findElement(By.xpath("//div[@class='Header_threeDots__QZzHQ']")).click();
